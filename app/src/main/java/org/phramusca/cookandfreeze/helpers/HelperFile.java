package org.phramusca.cookandfreeze.helpers;
...
//        } else
        if(externalFilesDir.length > 0 && externalFilesDir[0] != null) {
    ...
    public static File getFolder(String... folders) {
    ...
    public static File getFile(String filename, String... folders) {
        return new File(getFolder(folders), filename);
    }

    public static String readTextFile(String filename, String... folders) {
    ...
    public static boolean writeTextFile(String filename, String text, String... folders) {
        File file = getFile(filename, folders);
        try {
    ...
    public static void writeTextFileToInternalMemory(Context context, String filename, String text) {
        try {
    ...
    public static String readTextFileFromInternalMemory(Context context, String filename) {
        String ret = "";
        try {
